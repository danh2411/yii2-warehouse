...
<div class="container">
    <form method="post" action="/warehouse/successredis?id=<?php echo $query['id']; ?>" enctype="multipart>
        ...
        <div class="col ">
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input" name="container"
                    id="container" aria-describedby="inputGroup-sizing-sm" value="<?php echo $query['container']; ?>">
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input" name="receiving"
                    id="receiving" aria-describedby="inputGroup-sizing-sm" value="<?php echo $query['container']; ?>">
